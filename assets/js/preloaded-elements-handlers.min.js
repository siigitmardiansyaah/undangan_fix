						...
						if (!e) {
							const t = this.getDocumentSettings(),
								...
								triggerPopupEvent = (e) => {
									...
									elementorFrontend.elements.$document.trigger(t, [s, this]),
										window.dispatchEvent(
											new CustomEvent(t, { detail: { id: s, instance: this } })
										);
								};
				...
				async initSlider() {
					...
					n &&
						(this.swiper.on("slideChangeTransitionStart", function () {
							e.find(s.selectors.slideInnerContents)
								.removeClass(s.classes.animated + " " + n)
								.hide();
						}),
						this.swiper.on("slideChangeTransitionEnd", function () {
							e.find(s.selectors.slideInnerContents)
								.show()
								.addClass(s.classes.animated + " " + n);
						}));
				}
				onInit() {
					elementorModules.frontend.handlers.Base.prototype.onInit.apply(
		...
		8208: (e, t, s) => {
			...
			class TOCHandler extends elementorModules.frontend.handlers.Base {
				...
				collapseBodyListener() {
					...
					"desktop" === t || e.indexOf(t) >= e.indexOf(s)
						? n || this.collapseBox()
						: n && this.expandBox();
				}
				onElementChange(e) {
		...
		2083: (e, t) => {
			...
			class _default extends elementorModules.frontend.handlers.Base {
				...
				bindEvents() {
					...
					if (n && i)
						return void this.$element.find(o.toggleButton).attr("href", s);
